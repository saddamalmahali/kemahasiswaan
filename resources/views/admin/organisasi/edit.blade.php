        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Form Edit Organisasi</h3>
                </div>
                <form action="{{url('/admin/organisasi/simpan_edit')}}" method="post" enctype="multipart/form-data" style="padding :0; margin:0;">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-4">
                            <div class="form-group{{ $errors->has('nama') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="nama" class="form-control" placeholder="HIMATIF" value="{{$organisasi->nama}}">
                                @if ($errors->has('nama'))
                            ...
                            <div class="form-group{{ $errors->has('tahun_berdiri') ? ' has-error' : '' }}">
                                ...
                                <input type="number" name="tahun_berdiri" class="form-control" placeholder="Masukan Tahun Berdiri Organisasi" value="{{$organisasi->tahun_berdiri}}">
                            ...
                            <div class="form-group{{ $errors->has('jenis_organisasi') ? ' has-error' : '' }}">
                                ...
                                <select name="jenis_organisasi" class="form-control" >
                                    ...
                                    <option value="hima" {{$organisasi->jenis_organisasi == 'hima' ? 'selected':''}}>HIMA</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group{{ $errors->has('nama_pimpinan') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="nama_pimpinan" class="form-control" placeholder="Masukan Nama Pimpinan" value="{{$organisasi->nama_pimpinan}}">  
                            ...
                            <div class="form-group{{ $errors->has('deskripsi') ? ' has-error' : '' }}">
                                ...
                                <textarea name="deskripsi" class="form-control" rows="4">{{$organisasi->deskripsi}}</textarea>
