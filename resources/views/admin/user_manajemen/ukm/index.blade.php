        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    <h3 class="panel-title">Data User UKM</h3>
                </div>
                <div class="panel-body">
                    ...
                    <div class="pull-right">
                        <a href="{{url('/tambah_user_ukm')}}" class="btn btn-primary btn-sm" style="margin:10px;"><i class="fa fa-plus"></i>&nbsp;Tambah User</a>
                    </div>
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:center;">Bagian UKM</th>
                        ...
                        <tbody>
                            ...
                            @forelse ($data_user as $user)
                                <tr>
                                    ...
                                    <td align="center">
                                        <a href="{{url('/update_user_ukm').'/'.$user->id}}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
