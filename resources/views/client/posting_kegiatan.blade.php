        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form action="{{url('/client/tambah_kegiatan')}} " method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                            <label for="title">Judul Kegiatan</label>
                            <input type="text" class="form-control" name="title" placeholder="Masukan Judul Kegiatan">
                            @if ($errors->has('title'))
